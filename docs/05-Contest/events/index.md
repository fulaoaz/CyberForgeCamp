...
<script>
    /** 解析国内赛时间串 yyyy年mm月dd日 hh:mm（东八区墙上时刻，与 CyberForgeCamp 赛事数据 CN.json 一致） */
...
> 数据基于 [CyberForgeCamp 赛事数据](https://github.com/TianJiHub/CyberForgeCamptime) 项目，每小时更新一次。  
...
=== "国内赛事"
    ...
    /GET https://raw.githubusercontent.com/TianJiHub/CyberForgeCamp/main/CN.json
    ```
    ...
    ```json
    {
      ...
      "data": {
        "result": [
          {
            "name": "CyberForgeCamp",
            "link": "https://tianjihub.github.io/CyberForgeCamp/",
...
=== "国外赛事"
    ...
    /GET https://raw.githubusercontent.com/TianJiHub/CyberForgeCamp/main/Global.json
    ```
...
> 国内赛事数据来源: 三哈，探姬 - https://github.com/TianJiHub/CyberForgeCamptime 
